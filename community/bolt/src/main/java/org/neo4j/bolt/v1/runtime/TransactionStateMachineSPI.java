            ...
            ResultBuffer resultBuffer )
    {
        ...
        return new BoltResultHandle()
        {
            ...
            public BoltResult start() throws KernelException
            {
                try
                {
                    QueryExecution queryExecution = queryExecutionEngine.executeQuery( statement, params, transactionalContext, resultBuffer );
                    return new QueryExecutionBoltResult( queryExecution );
                }
