...
public class AcceptanceSpecSuiteTest
{
    ...
    public static final String FEATURE_TO_RUN = "AggregationAcceptance.feature";
    public static final String SCENARIO_NAME_REQUIRED = "Using a optional match after aggregation and before an aggregation";
